...
public class SqlPro {
  ...
  public static float 默认数量=5;//当物料没设定装载系数时的值
   public static String L_总状态="未准备";//未准备，正常
    ...
    public static String 物料="通用物料";
    public static String 供应类型="供应类型";
    public static String 采购员="采购员";
    public static String 计划员="计划员";
    public static String 计划方式="计划方式";
    public static String 子库存="子库存";
    public static String 物料状态="物料状态";
    public static String 库管员="库管员";
    public static String 借用="借用_归还";
    public static String 事务处理类型="事务处理类型";
    public static String 事务来源类型="事务来源";
    public static String 物料事务处理="物料事务处理";
    public static String 请求="请求";
     public static String 协议="协议";
    public static String 总库="库房_ALL";
    public static String 供应商="供应商";
    public static String 借用者="借用者";
    public static String bom="BOM";
    public static String 人员配合="同组人员";
    public static String 刀具看板="刀具看板";
    public static String 协议视图="协议视图";
    public static String 申请行="申请行";
    public static String 申请题头="申请题头";
    public static String 申请视图="申请视图";
    public static String 注册="注册";
    public static String 品牌="品牌";
    public static String 订单视图="订单视图";
    public static String 订单题头="订单接受题头";
     public static String 订单接受="订单接受";
    public static String 入库视图="入库视图";
    public static String 入库验收表="入库验收表";
    public static String 销售订单类型="销售订单类型";
    public static String 销售订单题头="销售订单";
    public static String 销售订单行="销售订单行";
    public static String 销售订单视图="销售订单视图";
    public static String 发票批次="发票批次";
     public static String 发票="发票";
     public static String 发票分配="发票分配";
    public static String 部门="部门";
     public static String 人员="人员";
    public static String 资产类别="资产类别";
    public static String 费用类别="费用类别";
     public static String 增加方式="增加方式";
     public static String 折旧方法="折旧方法";
     public static String 清理方式="清理方式";
     public static String 折旧率="折旧率";
     public static String 使用状态="使用状态";
      public static String 固定资产="固定资产";
     public static String 设备维修="设备维修";
      public static String 维修备件="维修备件";
        public static String 资产转移="资产转移";
         public static String 验收管理="验收管理";
    public static String 资产借归管理="资产借归管理";
     public static String 折旧视图="折旧视图";
     public static String 资产事务视图="资产事务视图";
      public static String 资产转移视图="资产转移视图";
      public static String 分组="分组";
      public static String 货位="货位表";
      public static String 推垛机="推垛机";
      public static String 托盘="托盘";
       public static String 货位限制="限制货位";
      public static String 物料托盘="物料托盘";
      public static String 技术订单题头="技术订单题头";
      public static String 技术订单行="技术订单行";
       public static String 技术订单视图="技术订单视图";
