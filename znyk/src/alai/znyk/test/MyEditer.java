...
public class MyEditer extends AbstractCellEditor
...
//
    ...
    public MyEditer(final JTextField textField) {
     ...
     */
    public MyEditer(final JCheckBox checkBox) {
     ...
     */
    public MyEditer(final JComboBox comboBox) {
    ...
    public Component getTableCellEditorComponent(JTable table, Object value,
    	...
    	if(value instanceof Boolean){
    		 ...
    		 ((JCheckBox)editorComponent).setSelected(((Boolean)value).booleanValue());
    	        ...
    	        ((JCheckBox)editorComponent).setOpaque(false);
    	        delegate.setValue(value);
    	        ((JCheckBox)editorComponent).addActionListener(delegate);
    	        ((JCheckBox)editorComponent).setRequestFocusEnabled(false);
    	        return editorComponent;
